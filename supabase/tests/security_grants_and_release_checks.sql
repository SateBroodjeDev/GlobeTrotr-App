...
DO $$ BEGIN
 IF has_function_privilege('authenticated','public.get_public_platform_status()','EXECUTE') OR has_function_privilege('authenticated','public.list_public_testimonials()','EXECUTE') THEN RAISE EXCEPTION 'Authenticated heeft nog een onnodig openbaar SECURITY DEFINER-recht'; END IF;
