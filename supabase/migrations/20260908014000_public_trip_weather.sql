-- Geef de publieke reis alleen een weerbeschikbaarheidsvlag voor Pro en Agency.
-- De plannaam zelf wordt niet openbaar gemaakt.
...
BEGIN
  ...
  SELECT workspace.public_token,
    ...
    workspace.plan IN ('pro', 'agency')
  INTO v_token, v_author, v_weather_enabled
  ...
  v_result := jsonb_build_object(
    ...
    'authorName', v_author,
    'weatherEnabled', v_weather_enabled,
    'stops', COALESCE((
