export const PUBLIC_TODAY = {
  ...
  completed: [
    ...
    ["Betrouwbaarder live weer via een beveiligde serververbinding", "More reliable live weather through a secured server connection"],
  ...
  tests: [
    ["Nodig één bestaand account uit en test accepteren én weigeren", "Invite one existing account and test both acceptance and decline"],
