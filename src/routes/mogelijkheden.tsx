...
const CAPABILITIES = [
  ...
  { icon: WifiOff, title: ["Voorbereid zonder internet", "Prepared without internet"], copy: ["Bewaar bewust een beperkt dagoverzicht op je apparaat. Route en planning blijven leesbaar, nieuwe uitgaven wachten op jouw synchronisatie en dagboektekst blijft lokaal als concept bewaard.", "Explicitly save a limited daily view on your device. Route and itinerary remain readable, new expenses wait for you to sync them and journal text stays available as a local draft."], badge: ["Offline dagoverzicht", "Offline daily view"] },
  { icon: BookHeart, title: ["Herinneringen in een echt reisdagboek", "Memories in a real travel journal"], copy: ["Schrijf per reisdag, voeg meerdere afgeschermde foto's met bijschriften toe, kies een omslag en bepaal per herinnering of die privé, voor reisleden of openbaar is.", "Write for each travel day, add multiple protected photos with captions, choose a cover and decide whether each memory is private, for trip members or public."], badge: ["Tijdlijn, galerij en kaart", "Timeline, gallery and map"] },
