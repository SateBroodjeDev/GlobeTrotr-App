        ...
        <CardContent className="space-y-8 p-6 sm:p-8">
          ...
          >
            <ul className="list-disc space-y-2 pl-5">
              ...
              <li>
                {text(
                  "Reizen, routes, persoonlijke favoriete plaatsen, planning, reisleden, boekingen, uitgaven, taken, checklists, paklijsten, dagboektekst en maximaal acht dagboekfoto’s per herinnering, reisvergelijkerkandidaten, reacties, peilingen, stemmen en uploads: om de gekozen functies en samenwerking te leveren; uitvoering van de overeenkomst. Je kiest per dagboekitem of het alleen voor jou, voor reisgenoten of in de geëxporteerde gedeelde reisgids zichtbaar is. Dagboekfoto’s staan in afgeschermde opslag en worden tijdelijk via een ondertekende link getoond. Favoriete plaatsen zijn alleen voor jou zichtbaar en blijven bewaard totdat je ze verwijdert of je account wist. Taken en checklists zijn zichtbaar voor bevoegde reisleden. Reacties en stemmen zijn alleen zichtbaar voor bevoegde reisleden. Reacties verdwijnen wanneer hun kandidaat wordt verwijderd; een afgesloten peiling bewaart de keuze en stemtotalen als reisbesluit.",
                  "Trips, routes, personal favourite places, itinerary, members, bookings, expenses, tasks, checklists, packing lists, journal text and up to eight journal photos per memory, trip-comparison candidates, comments, polls, votes and uploads: to provide selected features and collaboration; performance of the agreement. For each journal entry, you choose whether it is visible only to you, to travellers or in the exported shared trip guide. Journal photos are kept in protected storage and displayed through a temporary signed link. Favourite places are visible only to you and remain stored until you remove them or delete your account. Tasks and checklists are visible to authorised trip members. Comments and votes are visible only to authorised trip members. Comments are removed when their candidate is deleted; a closed poll retains the choice and vote totals as a trip decision.",
                )}
              </li>
              <li>
                {text(
          ...
          <section id="browseropslag">
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              {text(
                "De inventaris omvat localStorage, sessionStorage, functionele cookies en vergelijkbare browseropslag. De website op globetrotr.nl en het accountportaal op portal.globetrotr.nl hebben gescheiden browseropslag. Je inlogsessie, tokens en lokale reiscache blijven uitsluitend op de portalhost. De publieke website vraagt het portaal via een afgeschermd frame alleen of je bent ingelogd en ontvangt daarbij je weergavenaam en een tijdelijk ondertekende avatar-URL. Deze beperkte status wordt voor het huidige browsertabblad in sessionStorage bewaard; inlogtokens worden niet gekopieerd of via de URL verstuurd. GlobeTrotr gebruikt geen advertentie-, marketing- of gedragsprofileringcookies. De taalvoorkeur wordt alleen na jouw privacykeuze bewaard; thema en zijbalkstand worden bewaard wanneer je die functies zelf instelt. Turnstile kan noodzakelijke beveiligingsgegevens gebruiken. Kies je voor Google of Discord, dan kan die aanbieder op zijn eigen domein cookies of opslag gebruiken volgens zijn eigen beleid.",
                "The inventory covers localStorage, sessionStorage, functional cookies and similar browser storage. The website at globetrotr.nl and account portal at portal.globetrotr.nl have separate browser storage. Your sign-in session, tokens and local trip cache remain exclusively on the portal host. Through an isolated frame, the public website only asks the portal whether you are signed in and receives your display name and a temporary signed avatar URL. This limited status is stored in sessionStorage for the current browser tab; sign-in tokens are never copied or sent through the URL. GlobeTrotr uses no advertising, marketing or behavioural-profiling cookies. The language preference is stored only after your privacy choice; theme and sidebar state are stored when you choose those functions. Turnstile may use necessary security data. If you choose Google or Discord, that provider may use cookies or storage on its own domain under its own policy.",
              )}
            </p>
          </section>
          <Policy
