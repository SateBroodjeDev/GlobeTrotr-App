        ...
        <CardContent className="space-y-8 p-6 sm:p-8">
          ...
          >
            <ul className="list-disc space-y-2 pl-5">
              ...
              <li>
                {text(
                  "Reizen, routes, persoonlijke favoriete plaatsen, planning, reisleden, boekingen, uitgaven, taken, checklists, paklijsten, reisvergelijkerkandidaten, reacties, peilingen, stemmen en uploads: om de gekozen functies en samenwerking te leveren; uitvoering van de overeenkomst. Favoriete plaatsen zijn alleen voor jou zichtbaar en blijven bewaard totdat je ze verwijdert of je account wist. Taken en checklists zijn zichtbaar voor bevoegde reisleden. Reacties en stemmen zijn alleen zichtbaar voor bevoegde reisleden. Reacties verdwijnen wanneer hun kandidaat wordt verwijderd; een afgesloten peiling bewaart de keuze en stemtotalen als reisbesluit.",
                  "Trips, routes, personal favourite places, itinerary, members, bookings, expenses, tasks, checklists, packing lists, trip-comparison candidates, comments, polls, votes and uploads: to provide selected features and collaboration; performance of the agreement. Favourite places are visible only to you and remain stored until you remove them or delete your account. Tasks and checklists are visible to authorised trip members. Comments and votes are visible only to authorised trip members. Comments are removed when their candidate is deleted; a closed poll retains the choice and vote totals as a trip decision.",
                )}
              </li>
              <li>
                {text(
