...
import { BarChart3, Building2, CreditCard, History, LayoutDashboard, Settings2, ShieldCheck, Users } from "lucide-react";
...
function AgencyAdminLayout(){
 ...
 if(access.isLoading)return <p className="text-sm text-muted-foreground">{text("Agency-rechten ladenâ€¦","Loading Agency permissionsâ€¦")}</p>;
