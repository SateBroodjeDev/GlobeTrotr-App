...
import { BarChart3, Building2, CreditCard, LayoutDashboard, Settings2, ShieldCheck, Users } from "lucide-react";
...
const items=[
 ...
 {to:"/team",nl:"Klanten per reis",en:"Clients per trip",icon:Users,permission:"members_manage"},
 {to:"/analytics",nl:"Operatie",en:"Operations",icon:BarChart3,permission:"analytics_view"},
 {to:"/billing",nl:"Abonnement",en:"Plan",icon:CreditCard,permission:"billing_manage"},
] as const;
